...
const Calendar = () => {
    return (
            <div className='w-full max-w-lg mb-4 p-6 mx-auto bg-white rounded-2xl shadow-xl flex flex-col'>
                <div className="flex justify-between pb-4">
                    ...
                    <span className="uppercase text-sm font-semibold text-gray-600">April - 2024</span>
                    <div className="rotate-90 cursor-pointer">
                        <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.001 6L6.00098 1L1.00098 6" stroke="black" stroke-opacity="0.4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
